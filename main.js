...
document.getElementById("round3").addEventListener("click", myFunction);
document.getElementById("round5").addEventListener("click", myFunction);
document.getElementById("round7").addEventListener("click", myFunction);
document.getElementById("round9").addEventListener("click", myFunction);
